...
# Preprocess
prep_cfg_file = f"{profile_root_dir}/nvidia_prep.yaml"
...
for scene in scene_names:
    ...
    pycode = f"CUDA_VISIBLE_DEVICES={GPU_ID} python mosca_precompute.py --ws {data_root_dir}/{scene} --cfg {profile_root_dir}/nvidia_prep.yaml >> {logdir} 2>&1"
